...
//            NSLog(@"Input was %@", inputString);
            ...
            // the input only takes in a pizza.. so using a method you would take it out
...
//            NSLog(@"Toppings =  %@", toppings);
            ...
            // you can call the pizza class because pizza is alloc init is inside restaurantkitchn
